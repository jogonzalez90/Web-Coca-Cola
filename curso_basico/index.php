...
<html>
    <head>
        ...
        <script src="https://kit.fontawesome.com/085c0f0e27.js" crossorigin="anonymous"></script>
    </head>
    <body>
        <header>
            <div class="container">
        ...
        <main>
            ...
            <section id="nosotros" class="seccion">
                <div class="container">
                    <p>Mauris maximus iaculis mauris, venenatis luctus nisi tincidunt sed. Aenean risus tellus, pretium nec nisl eu, scelerisque faucibus neque. Proin id sagittis odio. Morbi et viverra odio. Vestibulum commodo molestie blandit.</p>
                </div>
            </section>
                        ...
                        <div class="columna columna-33 columna-mobile-100">
                            <div class="bloque-servicio">
                                ...
                                <div class="bloque-contenido-servicio">
                                    <h3>Servicio 1</h3>
                                    <p>In mi ante, molestie sed augue quis, hendrerit tristique mauris. Ut sit amet vestibulum massa. Sed interdum augue eros, a lacinia massa tincidunt nec.</p>
            ...
            <section id="contactenos" class="seccion">
                <iframe width="520" height="400" frameborder="0"  id="gmap_canvas" src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=%20Bogot%C3%A1+(Colombia)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe> 
                <div class="container-fluid">
                    <div class="row">
									...
									if($_SERVER["REQUEST_METHOD"] == "POST")
									{
										...
										if(isset($nombre))
										{
											if(isset($email))
											{
												if(isset($mensaje))
												{
													$para = "jogoca990@gmail.com"; //colocar aqui el correo a dodne quieres que llegue
													$asunto = "Esto es una prueba";
													$cuerpo = $nombre."\n".$email."\n".$mensaje;
													$adicional = "From: noreply@johans.com";
            ...
            <div class="container">
                <div class="row">
                    <div class="columna columna-25 columna-mobile-100">
                        ...
                        <p>
                            In mi ante, molestie sed augue quis, hendrerit tristique mauris. Ut sit amet vestibulum massa. Sed interdum augue eros, a lacinia massa tincidunt nec.
                        </p>
                    </div>
                    <div class="columna columna-25 columna-mobile-100">
                        <h3>
                    ...
                    <div class="columna columna-25 columna-mobile-100">
                        <h3>
                            Datos de contactenos
                        </h3>
                        <ul>
                            <li>jogoca990@gmail.com</li>
                            <li>+573142146337</li>
                            <li>Cl 128 ABis # 88B - 22 Suba Rincón<br>Bogotá Colombia</li>
                        </ul>
                    </div>
                    <div class="columna columna-25 columna-mobile-100">
                        <h3>
